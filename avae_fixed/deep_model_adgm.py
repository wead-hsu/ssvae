...
class DeepModel():
    ...
    def get_params(self, only_trainable = False):
        ...
        #2. samples to LSTM hid: l_hid, l_yz  <--- l_label_in, l_z_in
    ...
    def _calc_kl(self, incomings, return_mode = 'by_batch'):
        ...
        y, z_mu, z_var, a_mu, a_var = incomings
        ...
        kl_pa, kl_pa_by_unit =  GaussianMarginalLogDensity([a_mu, a_var], normal_priori=True)
    ...
    def cost_label(self, incomings, dev_stage = False, return_mode = 'sum'):
        ...
        hid = self._gen_lm_init([y,z], dev_stage=dev_stage)
        ...
        # kl loss
        kl_p0y, kl_p0z, kl_qz, kl_qa, kl_pa = self._calc_kl([y, z_mu, z_var, a_mu, a_var],
    ...
    def train_function(self, semi_supervised= True):
        '''
        ...
        valid_words_u = 0
        if self.semi_supervised:
            outs2 = self.cost_unlabel([sym_s_u, sym_mask_u], dev_stage=False, sample_by_prob=self.sample_unlabel)
    ...
    def data_analysis_function(self):
        ...
        kl_p0z_by_unit, kl_qz_by_unit, kl_qa_by_unit, kl_pa_by_unit =\
            self._calc_kl([sym_y, z_mu, z_var, a_mu, a_var], return_mode='by_unit')

        ana_input = [sym_s, sym_mask, sym_y]
        ana_output = [a_mu, a_var, a, z_mu, z_var, z,
                     kl_p0z_by_unit, kl_qz_by_unit, kl_qa_by_unit, kl_pa_by_unit]
