...
def init_config( ):
    ...
    params['annealing_center'] = 62.0
    params['annealing_width'] = 10.0 #*7
    params['drop_out'] = 0.5
    params['beta'] = 1.5
...
params['train_batch_size'] = 10
#params['unlabel_batch_size'] = int(params['num_unlabel']/params['num_batches_train'])
params['unlabel_batch_size'] = 70
params['num_batches_train'] = params['num_train']/params['train_batch_size']
